...
The l64 builds of q now have a faster SIMD [`sum`](/basics/arith-integer/#sum) implementation using SSE. With the above paragraph in mind, it is easy to see why the results of the older and newer implementation may not match.
...
<i class="far fa-hand-point-right"></i> [Comparison](comparison.md), [`differ`](../ref/differ.md), [Match](../ref/match.md)