...
Further information can be found at the Knowledge Base article on [load balancing](/kb/load-balancing/).
...
more details, see the [Knowledge Base article on IPC](/kb/ipc/).
