...
Use the [`-19!` internal function](/basics/internal/#-19x-compress-file).
...
The [`21!` internal function](/basics/internal/#-21x-compression-stats) returns a dictionary of compression statistics, or an empty dictionary if the file is not compressed. 
```q
...
Yes, you have to use the [`-19!` internal function](/basics/internal/#-19x-compress-file), because the file format is different from gzip.
...
<i class="far fa-hand-point-right"></i> [blog.buttermountain.co.uk](http://blog.buttermountain.co.uk/2008/05/10/zfs-compression-when-du-and-ls-appear-to-disagree)

Compressed file size can be obtained from the [`-21!` internal function](/basics/internal/#-21x-compression-stats). 
...
<i class="far fa-hand-point-right"></i> [Linux production notes/Compression](linux-production/#compression)
...
<i class="far fa-hand-point-right"></i> [Linux production notes/Huge Pages and Transparent Huge Pages](linux-production/#huge-pages-and-transparent-huge-pages-thp)
