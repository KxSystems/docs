...
<tr> <td>Mlim</td> <td/> <td>Too many nested columns in [splayed tables](/kb/splayed-tables). (Prior to V3.0, limited to 999; from V3.0, 251; from V3.3, 65530)</td> </tr>
...
<tr> <td>splay</td> <td/> <td>nyi op on [splayed table](/kb/splayed-tables)</td> </tr>
<tr>
<td>stack</td>
...
<tr> <td>stype</td> <td class="nowrap">`'42`</td> <td>Invalid [type](datatypes.md) used to [signal](../ref/signal.md)</td> </tr>
...
From file ops and [IPC](/basics/ipc)
...
<tbody>
<tr> <td>cores</td> <td>The license is for [fewer cores than available](/kb/cpu-affinity)</td> </tr>
...
<i class="far fa-hand-point-right"></i> [Licensing](../tutorials/licensing.md)
