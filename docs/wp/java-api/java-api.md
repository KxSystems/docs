...
broad range of problem domains. They are available on <i class="fab fa-github"></i> [GitHub](https://github.com/kxcontrib/java-for-kdb-examples).
...
<i class="far fa-hand-point-right"></i> [_Building Real-time Tick Subscribers_](/wp/building_real_time_tick_subscribers.pdf) regarding the above vanilla setup
...
<i class="far fa-hand-point-right"></i> whitepaper [_Kdb+tick Profiling for Throughput Optimization_](/wp/kdbtick_profiling_for_throughput_optimization.pdf).
