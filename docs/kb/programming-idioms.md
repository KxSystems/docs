...
Use the [Scan extender](../ref/progressors.md#binary-maps) to build a moving list adding one item at the time from the original table, and the [`_` Drop operator](../ref/drop.md) to discard older values.
