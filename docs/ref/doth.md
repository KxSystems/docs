...
-   `z` is the content (string). Since 4.0 2025.11.25 (or kdbx 5.0 2025.10.18) a byte vector is also accepted.
...
-   `y` is a string. Since 4.0 2025.11.25 (or kdbx 5.0 2025.10.18) a byte vector is also accepted.
