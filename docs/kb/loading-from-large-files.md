...
Aborting the load (e.g. Ctrl-c, `kill -9`, and errors such as [`wsfull`](../basics/errors.md#wsfull)) is generally bad. The loader may have written some but not all of the data to the database. 
