...
example in the Knowledge Base [WebSocket article](/kb/websockets).
...
<i class="fab fa-github"></i> [github.com/KxSystems/kdb/c/c.js](https://github.com/KxSystems/kdb/blob/master/c/c.js)
...
```
<i class="far fa-hand-point-right"></i> Reference: [IPC](/ref/ipc) for more on serialization 
...
<i class="far fa-hand-point-right"></i> Knowledge Base: [Secure sockets stunnel](/kb/websockets/#secure-sockets-stunnel)
