<i class="far fa-hand-point-right"></i> [C client for kdb+](c-client-for-q)
...
The same as the q function [_apply_](/basics/unclassified/#apply), i.e. `.[x;y]`. Shared library only.
...
<!-- -   `handle=0`, this function is equivalent of [_apply_](/basics/unclassified/#apply) (`.`). -->
