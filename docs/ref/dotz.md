...
<i class="far fa-hand-point-right"></i> [`\b`](../basics/syscmds.md#b-views)
...
`test.q
```
<i class="far fa-hand-point-right"></i> [`.z.x` argv](#zx-argv)
...
2006.10.30
```
<i class="far fa-hand-point-right"></i> [`.z.k` release date](#zk-release-date)
...
<i class="far fa-hand-point-right"></i> [`.z.K` version](#zk-version)
...
<i class="far fa-hand-point-right"></i> [`.z.f` file](#zf-file)
...
<i class="far fa-hand-point-right"></i> [Knowledge Base: File compression](/kb/file-compression)
...
<i class="far fa-hand-point-right"></i> Knowledge Base: [Callbacks](../kb/callbacks/), _Q for Mortals:_ [11.6 Interprocess Communication](http://code.kx.com/q4m3/11_IO/#116-interprocess-communication)
...
<i class="far fa-hand-point-right"></i> [`.z.pw` password check](#zpw-validate-user)
...
The exit parameter is the argument to the [exit](errors/#exit) function, or 0 if manual exit with [`\\` quit](../basics/syscmds.md#quit)
...
<i class="far fa-hand-point-right"></i> [`.z.pc` port close](#zpc-close), [`exit`](../basics/errors/#exit), [`\\` quit](../basics/syscmds.md#quit)
...
!!! warning "Slaves to peach"
    ...
    The processes with these handles must not be used for other messaging; Each Parallel will close them if it receives anything other than a response message.
...
<i class="far fa-hand-point-right"></i> [Knowledge Base: LoadBalancing](../kb/load-balancing.md)
...
<i class="far fa-hand-point-right"></i> [`.z.ps`](#zps-set)
...
<i class="far fa-hand-point-right"></i> [`.z.pp` port post](#zpp-http-post), [.h](doth.md)
...
q)\x .z.pi
```
<i class="far fa-hand-point-right"></i> [Changes in V2.4](../releases/ChangesIn2.4.md#zpi)
...
<i class="far fa-hand-point-right"></i> [`.z.pc` port close](#zpc-close), [`.z.pw` validate user](#zpw-validate-user)
...
<i class="far fa-hand-point-right"></i> [`.h`](doth.md)
...
<i class="far fa-hand-point-right"></i> [`.z.pg`](#zpg-get)
...
<i class="far fa-hand-point-right"></i> [`.z.po` port open](#zpo-open),  [Changes in 2.4](../releases/ChangesIn2.4.md#zpw)
...
<i class="far fa-hand-point-right"></i> [`\t`](../basics/syscmds.md#t-timer)
...
Where `f` is a binary function, `.z.vs` is evaluated _after_ a value is set globally in the root namespace (e.g. `a`, `a.b`): `x` is the symbol of the variable that is being modified and `y` is the index. This is not triggered for function-local variables, nor globals that are not in the default namespace (e.g. those prefixed with a dot such as `.ab.c`) .
...
<i class="far fa-hand-point-right"></i> [`.z.po` port open](#zpo-open), [`.z.pc` port close](#zpc-close), [`.z.pw` validate user](#zpw-validate-user)
...
<i class="far fa-hand-point-right"></i> [`.z.wc` websocket close](#zwc-websocket-close), [`.z.po` port open](#zpo-open), [`.z.pc` port close](#zpc-close), [`.z.pw` validate user](#zpw-validate-user)
