...
Q has built-in authentication via the [`-U`](/basics/cmdline/#-u-usr-pwd) and [`-u`](/basics/cmdline/#-u-usr-pwd-local) command line options.

Access control is very flexible, through hooking the message interface [`.z.pg`](/basics/dotz/#zpg-get "get"), [`.z.ps`](/basics/dotz/#zps-set "set"), and validating the input before execution.
```q
...
<i class="far fa-hand-point-right"></i> [Using `.z`](using-dotz) for some concrete examples, such as controlaccess.q
