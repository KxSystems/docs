...
<i class="far fa-hand-point-right"></i> [`.Q.id`](dotq/#qid-purge) (purge), [`.Q.res`](dotq/#qres-k-words) (reserved words)
...
<tr>
<tr>
<td class="kx-glyph">[`@`](#at)<br>[`.`](overloads/#dot)</td><td>[Apply](apply)<br>[Index](apply)<br>[Trap](apply/#trap)<br>[Amend](amend)</td>
<td class="kx-glyph">[`$`](#dollar)</td><td>[Cond](cond)<br>[Cast](cast)<br>[Tok](tok)<br>[Enum](enum)<br>[Pad](pad)<br>[`mmu`](mmu)</td>
<td class="kx-glyph">[`!`](#bang)</td><td>[Dict](dict)<br>[Enkey](enkey/#enkey)<br>[Unkey](enkey/#unkey)<br>[Enumeration](enumeration.md)<br>[Flip Splayed](flip-splayed)<br>[Display](display)<br>[internal](internal-functions)<br>[Update<br>Delete](/basics/funsql)</td>
<td class="kx-glyph">[`?`](#query)</td><td>[Find](find)<br>[Roll, Deal](roll-deal)<br>[Enumerate](enumerate.md)<br>[Enum Extend](enum-extend.md)<br>[Select](/basics/funsql/#select)<br>[Exec](/basics/funsql/#exec)<br>[Simple Exec](/basics/funsql/#simple-exec)</td>
</tr>
<tr>
<td class="kx-glyph">[`/`](#slash)<br>[`\`](overloads/#backslash)</td><td>[Over](progressive-operators)<br>[Scan](progressive-operators)</td>
<td class="kx-glyph">`/:`<br>`\:`</td><td>[Each Right<br>Each Left](distributive-operators/#each-left-and-each-right)</td>
<td class="kx-glyph">[`':`](#quote-colon)</td><td>[Each Parallel](distributive-operators/#each-parallel)<br>[Each Prior](each/#each-prior)</td>
<td class="kx-glyph">[`'`](#quote)</td><td>[Case](case)<br>[Compose](compose)<br>[Each](distributive-operators/#each)<br>[Signal](signal)</td>
</tr>
<tr>
<td class="kx-glyph">`|`</td> <td>[Maximum<br>OR](maximum)</td>
<td class="kx-glyph">`&`</td> <td>[Minimum<br>AND](minimum)</td>
<td class="kx-glyph">`:`</td><td>[Amend](amend)<br>[unary form](/basics/exposed-infrastructure/#unary-forms)</td>
</tr>
<tr>
<td class="kx-glyph">`+`</td><td>[Add](add)</td>
<td class="kx-glyph">`-`</td><td>[Subtract](subtract)</td>
<td class="kx-glyph">`*`</td><td>[Multiply](multiply)</td>
<td class="kx-glyph">`%`</td><td>[Divide](divide)</td>
</tr>
<tr>
<td class="kx-glyph">[`#`](#hash)</td><td>[Take](take.md)<br>[Set Attribute](set-attribute.md)</td>
<td class="kx-glyph">[`_`](#underscore)</td><td>[Cut](cut)<br>[Drop](drop)</td>
...
<td class="kx-glyph">`>`<br>`>=`</td><td>[Exceeds](/basics/comparison/#six-comparison-operators)<br>[At Least](/basics/comparison/#six-comparison-operators)</td>
<td class="kx-glyph">`~`</td><td>[Match](/basics/comparison/#match)</td>
</tr>
<tr>
</tr>
<tr>
<td class="kx-glyph">`\\`</td><td>quit</td>
<td class="kx-glyph"><code class="nowrap">::</code></td><td>identity<br>generic null<br>global amend<br>set view</td>
<td class="kx-glyph">`0`<br><span class="nowrap">`1`, `-1`</span><br>`2`, `-2`<br>_n_, _-n_</td><td>console<br>stdout<br>stderr<br>handle</td>
<td class="kx-glyph"><span class="nowrap">`0:`</span><br>`1:`<br>`2:`</td><td>text file<br>binary file<br>C shared objects</td>
</tr>
<tr>
<td class="kx-glyph">`()`</td><td>precedence<br>list<br>table</td>
<td class="kx-glyph">`[]`</td><td>expression block<br>argument list</td>
<td class="kx-glyph">`{}`<br>`;`</td><td>lambda<br>separator</td>
...
<i class="far fa-hand-point-right"></i> [Attributes](elements/#attributes)
...
<i class="far fa-hand-point-right"></i> [command-line options](cmdline), [system commands](syscmds), [OS Commands](syscmds/#os-commands), [`system`](syscmds/#system)
