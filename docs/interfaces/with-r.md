...
<i class="far fa-hand-point-right"></i> [Kdb+ server for ODBC](/interfaces/q-server-for-odbc)
...
<i class="fab fa-github"></i> [KxSystems/cookbook/r](https://github.com/KxSystems/cookbook/tree/master/r)
...
<i class="fab fa-github"></i> [kxsystems/embedr](https://github.com/kxsystems/embedr)
...
```
<i class="far fa-hand-point-right"></i> Andrey’s [althenia.net/qml](http://althenia.net/qml)
...
```
<i class="far fa-hand-point-right"></i> [Pivoting tables](/kb/pivoting-tables)
...
```
<i class="far fa-hand-point-right"></i> [Knowledge Base: Timezones and Daylight Saving Time](/kb/timezones)
