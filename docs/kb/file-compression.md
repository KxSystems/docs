...
LZ4 is great at decompression speed is average in [compression ratio](compression/compressionratio.md). The commpression level has a significant impact on compression speed. Level 5 is a good choice if you aim fast queries and low storage costs. Avoid high compression levels (above 11).
